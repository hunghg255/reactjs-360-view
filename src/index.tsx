...
class React360Viewer extends Component {
  ...
  componentDidMount() {
    ...
    this.viewPortElementRef = this.viewerContainerRef.querySelectorAll(
  ...
  preloadImages() {
    if (this.imageData.length > 0) {
      try {
        ...
        for (const src of this.imageData) {
          this.addImage(src);
        }
      } catch (error) {
  ...
  zoom(clicks) {
    ...
    } else if (this.currentScale - factor > 1) {
      this.currentScale -= factor;
    } else {
      this.currentScale = 1;
    }
  ...
  loopImages() {
    const loop = this.props.loop ? this.props.loop : 1;
        ...
        >
          ...
          <abbr title='Fullscreen Toggle'>
            <div className='v360-fullscreen-toggle text-center' onClick={this.toggleFullScreen}>
              ...
              >
                <i
                  className={
                    this.state.isFullScreen ? 'fas fa-compress text-lg' : 'fas fa-expand text-lg'
                  }
                ></i>
              </div>
            </div>
          ...
          <div id='v360-menu-btns' className={this.props.buttonClass}>
            <div className='v360-navigate-btns'>
              ...
              {this.state.panmode ? (
                <Button clicked={this.togglePanMode} text='360&deg;' />
              ) : (
